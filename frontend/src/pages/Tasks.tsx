    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section>
          ...
          <p className="text-gray-600 mb-6">Engage in a conversation with AI for progress updates and plans</p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Share your thoughts here</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Provide project updates</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Share any issues you're facing</p>
              </div>
            </div>
          </div>
        </section>
