    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-gray-600">View and manage your teams effectively</p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 text-center mt-1">Progress: 80%</p>
            </div>
            {/* Team 2 */}
            <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
              <div className="flex justify-center mb-4">
              ...
              <p className="text-sm text-gray-500 text-center mt-1">Progress: 50%</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <button className="flex items-center p-4 bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">Join an existing team using a code</p>
              </div>
            </button>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">Welcome back! Stay productive.</p>
            </div>
          </div>
